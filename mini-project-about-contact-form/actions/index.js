...
import { cacheTag, revalidatePath, revalidateTag, unstable_cache } from "next/cache";
...
export async function updateContact(contactId, status) {
  try {
    ...
    revalidateTag("get-contact-stats");
    return { success: true };
  } catch (error) {
...
export async function getContactStats() {
  ...
  try {
    ...
    cacheTag("get-contact-stats")
    return {total, newCount, readCount, repliedCount}
  } catch (error) {
    return { success: false, error: "faild to send" };
  }
}
